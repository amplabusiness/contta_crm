...
CREATE INDEX idx_deals_empresa_cnpj ON public.deals(empresa_cnpj);
CREATE INDEX idx_tasks_assignee_id ON public.tasks(assignee_id);
CREATE INDEX idx_tasks_deal_id ON public.tasks(deal_id);
CREATE INDEX idx_empresa_socios_empresa_cnpj ON public.empresa_socios(empresa_cnpj);
CREATE INDEX idx_empresa_socios_socio_cpf ON public.empresa_socios(socio_cpf_parcial);
